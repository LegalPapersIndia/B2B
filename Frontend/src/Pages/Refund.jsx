      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-700 to-orange-600 px-8 py-14 text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight">Refund Policy</h1>
          ...
          <div className="p-8 md:p-12 lg:p-16 prose prose-slate max-w-none text-gray-700 leading-relaxed">
            ...
            <p className="mb-4">This Refund Policy applies only to fees paid directly to B2B Portal, such as:</p>
            ...
            <div className="bg-orange-50 border border-orange-100 rounded-2xl p-6 mt-8">
              <p className="text-gray-700 mb-2">
                Email: <a href="mailto:support@b2b.in" className="text-orange-600 hover:underline font-medium">support@b2b.in</a><br />
                Subject line: Refund Request – [Transaction ID / Order ID]
              </p>
            </div>

            <div className="mt-16 p-6 bg-blue-50 border border-blue-100 rounded-2xl text-center">
